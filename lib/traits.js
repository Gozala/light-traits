...
function Trait() {
  var result = Object.create(Trait.prototype)
  Array.prototype.map.call(arguments, trait).forEach(function(trait) {
...
, create: { value: function create(proto) {
    ...
    keys.forEach(function(key) {
      ...
      if (descriptor.required) {
        if (hasOwn.call(proto, key)) return;
...
, override: { value: function override() {
    var traits = Array.prototype.slice.call(arguments, 0).map(trait),
