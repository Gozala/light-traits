...
exports['test simple trait with required property'] = function(assert) {
  assert.sameTrait
  ( Trait(
    { a: Trait.required
    , b: 1
...
function(test) {
  try {
    var o4 = Object.create(Object.prototype, trait({ foo: required }));
...
exports['test diamond with conflicts'] = function(test) {
  ...
  var T4 = compose(makeT2(5), makeT3(5));
  try {
...
exports['test:providing requirements through proto'] = function(test) {
  try {
    var t = create({ required: 'test'}, compose({ required: required }));
